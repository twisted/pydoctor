...
SphinxGoogleDocstring = partialclass(
    sphinx_napoleon.docstring.GoogleDocstring, config=sphinx_napoleon_config, what='function'
)
SphinxNumpyDocstring = partialclass(
    sphinx_napoleon.docstring.NumpyDocstring, config=sphinx_napoleon_config, what='function'
)
...
class BaseDocstringTest(TestCase):
    ...
    def assertAlmostEqualSphinxDocstring(
        self, expected: str, docstring: str, type_: Type[Union[SphinxGoogleDocstring, SphinxNumpyDocstring]]
...
class TypeDocstringTest(BaseDocstringTest):
    ...
    def test_is_google_typed_arg(self):
        ...
        self.assertTrue(
            is_google_typed_arg("foo (`complicated string` or `strIO <twisted.python.compat.NativeStringIO>`)")
        )

        self.assertTrue(is_google_typed_arg("Random words are not a type spec (List[str] or list(bytes), optional)"))
        self.assertTrue(
            is_google_typed_arg("Random words are not a type spec (list of int or float or None, default: None)")
        )
        self.assertTrue(
            is_google_typed_arg(
...
"""
        ...
        self.assertAlmostEqualSphinxDocstring(expected2, docstring2, type_=SphinxGoogleDocstring)
...
"""
        self.assertEqual(expected.rstrip(), actual)
        self.assertAlmostEqualSphinxDocstring(expected, docstring, type_=SphinxNumpyDocstring)
...
"""
        ...
        self.assertAlmostEqualSphinxDocstring(expected, docstring2, type_=SphinxNumpyDocstring)
