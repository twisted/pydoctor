...
from pydoctor.napoleon.docstring import GoogleDocstring, NumpyDocstring, TypeDocstring, is_type, is_google_typed_arg
...
class BaseDocstringTest(TestCase):
    ...
    def assertAlmostEqualSphinxDocstring(self, expected: str, docstring: str, 
        ...
        Some approximation are applied with `re.sub` to `expected` string and the reST 
