...
class ModuleVistor(NodeVisitor):
    ...
    def _importAll(self, modname: str, lineno:int) -> None:
        ...
        for name in names:
            if self._handleReExport(exports, name, name, mod or modname) is True:
                continue
    ...
    def _handleReExport(self, curr_mod_exports:Collection[str], 
        ...
        if as_name in curr_mod_exports:
            ...
            if known_module:
                ...
                attr.value=ast.Name(attr.alias, ctx=ast.Load())
                return True
    ...
    def _importNames(self, modname: str, names: Iterable[ast.alias], lineno:int) -> None:
        ...
        for al in names:
            ...
            if mod is not None and self._handleReExport(exports, orgname, asname, mod or modname) is True:
                continue
    ...
    def visit_Import(self, node: ast.Import) -> None:
        ...
        for al in node.names:
            ...
            if asname is None:
                ...
                asname = fullname = fullname.split('.')[0]
