...
class ModuleVistor(ast.NodeVisitor):
    ...
    def _handleFunctionDef(self,
        ...
        func: model.Function = parent.contents.get(func_name) # type:ignore
        if func is not None and isinstance(func, model.Function) and any(
        ...
        return_annotation = Parameter.empty if return_type is None or epydoc2stan.is_none_literal(return_type) else _ValueFormatter(return_type, ctx=func)
